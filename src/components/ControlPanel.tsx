            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#222] p-4 rounded-lg">
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <span id="pause-label" className="text-sm text-gray-400 transition-colors">Pause at Sentence End</span>
                        <button
                            role="switch"
                            ...
                            className={clsx(
                                "w-11 h-6 rounded-full transition-colors relative focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-[#222]",
