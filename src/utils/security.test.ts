...
describe('security.ts', () => {
    describe('sanitizeInput', () => {
        it('should truncate text exceeding MAX_INPUT_LENGTH', () => {
            ...
            // We don't need to actually create a 5MB string to test the logic if we mock,
            // but the function doesn't depend on mocking constant.
            // Let's rely on the actual MAX_INPUT_LENGTH but maybe not create a massive string if we can avoid it?
            // Actually JS handles 5MB strings fine.
